...
export default function ForbiddenAccess() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen" role="alert" aria-live="assertive">
      <h1 className="text-secondary text-3xl font-bebas">Forbidden Access</h1>
      <p className="text-gray-700 text-lg font-ginora">You do not have permission to access this resource.</p>
    </div>
  );
}