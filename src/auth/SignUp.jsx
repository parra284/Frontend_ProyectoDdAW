...
export default function SignUp() {
  ...
  return (    <div className="bg-signup min-h-screen bg-cover bg-center flex items-center justify-center w-full px-2 py-8">
      <div className="flex flex-col items-center justify-center w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg p-4 sm:p-6 md:p-8 bg-white bg-opacity-90 rounded-lg shadow-md mx-2 sm:mx-4">
        <Form 
          ...
          fields={fields}
        />
        <p className="font-ginora flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2 mt-4 sm:mt-6 text-center">
